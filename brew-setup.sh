...
if is_arch; then
	...
	eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"
	echo "Homebrew installation completed for Debian (including Linux Mint, Ubuntu etc). Please restart your terminal or run 'source ~/.bashrc' to start using Homebrew."
